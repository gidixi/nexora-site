...
export default function HeroSection() {
  return (
    <section
      className="hero-section-wrap hero-pt section-page-x"
      style={{ paddingBottom: 60, maxWidth: 1100, margin: '0 auto' }}
    >
      <div className="hero-bg-mesh" aria-hidden />
      <div className="hero-content-layer" style={{ textAlign: 'center' }}>
